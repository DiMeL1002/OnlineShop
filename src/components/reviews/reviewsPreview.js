        ...
        <div className="reviews-preview">
            ...
            <div className="reviews-preview__review">
                <span className="reviews-preview__text">
                    Купил у вас в середине лета телефоны для себя, жены и дочери. Понравился ваш выбор и цены. Мне все телефоны обошлись не очень дорого. И доставка у вас очень быстрая, приятно.
                </span>
